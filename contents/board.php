        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="alert alert-info">
                    <strong>ALERT EXAMPLE :</strong> This is an alert example . You can use differnt classes like alert-success, alert-warning,etc. Please look <a href="http://www.designbootstrap.com/" target="_blank"> DesignBootstrap.com</a> fr more snippets and usage.
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="alert alert-warning">
                    ...
                    <br /> Css Class :<i> glyphicon glyphicon-user </i>
